...
class ImageAccess(
    ...
    override fun onCreate(owner: LifecycleOwner) {
        ...
        pickImage =
            registry.activityResultRegistry.register("openGallery", owner, ActivityResultContracts.GetContent(), ::galleryCallback)
        takePicture =
            registry.activityResultRegistry.register("takePicture", owner, ActivityResultContracts.TakePicture(), ::cameraCallback)
    }
